...
v4
    this version output XY pairs using saveXY.
...
def set_config(cfgset = "baseline"):
    ...
    if cfgset == "baseline":
        ...
        entity_options = "org_regex|arg_regex|ev_keywords|gaz|postag"
        event_options = "ev_keywords|entity"
        arg_options = "ev_keywords|entity"
        ploc_options = "ismax|arg"
...
#%%
def train_crf( cross_validation=False, options=None, ncrf = False, skipFeatureBuilding=False, skipTrain=False, mini=False, rnd = 21, mode = "entity", max_iterations = 100, _c1 = 0.1, _c2 = 0.1, test_size = 0.2):
    ...
    f1score = metrics.flat_f1_score(y_test, y_pred,
                          average='weighted', labels=labels)
